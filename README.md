...
[![My Skills](https://skillicons.dev/icons?i=anaconda,bash,bootstrap,c,codepen,css,flask,gcp,git,github,html,js,kali,linux,nextjs,nodejs,opencv,postman,python,react,sklearn,threejs,typescript,vscode&perline=12)](https://skillicons.dev)
